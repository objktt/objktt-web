...
const Layout: React.FC<LayoutProps> = ({ children }) => {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', minHeight: '100vh' }}>
        ...
        <Grid showLines={true}>
            ...
            <NavLink to="/" style={{ fontSize: '1.5rem', fontWeight: 700 }}>
              ...
              <svg 
                ...
                style={{ 
                  ...
                  width: 'auto',
                  display: 'block',
                  fill: 'var(--color-text)', // Use CSS variable for color
          ...
          <nav style={{ 
            ...
            <div style={{ display: 'flex', gap: '2rem' }}>
              <NavLink to="/" className={({ isActive }) => isActive ? "active-link" : ""} style={{ fontSize: '0.875rem', fontWeight: 500 }}>Index</NavLink>
              <NavLink to="/about" className={({ isActive }) => isActive ? "active-link" : ""} style={{ fontSize: '0.875rem', fontWeight: 500 }}>About</NavLink>
              <NavLink to="/events" className={({ isActive }) => isActive ? "active-link" : ""} style={{ fontSize: '0.875rem', fontWeight: 500 }}>Events</NavLink>
      ...
      {/* Footer / Bottom Grid Line */}
      <footer>
        <Grid showLines={false}>
           <div style={{ gridColumn: '1 / 9', padding: '2rem', fontSize: '0.75rem', opacity: 0.5 }}>
              © 2026 OBJKTT. Cultural Record Bar.
           </div>
           <div style={{ gridColumn: '9 / 13', padding: '2rem', fontSize: '0.75rem', textAlign: 'right' }}>
